    ...
    for i=1:num_electrode
        if visual_on==1
            ...
            burst_detection_struct = struct(... 
                ...
                'burst_locs',           {burst_locs}, ...
                'burst_spikes',         {burst_spikes}, ...
                'all_IBI_s',            {All_interburst_interval_sec}, ...
                'dev_IBI',              {dev_interburst_interval}, ...  % Deviation
                'cv_IBI',               {inter_burst_interval_CV}, ...  % Coefficient of variation
                'burst_mean_freq',      {Mean_burst_frequency} ...
            );
        end
    end
