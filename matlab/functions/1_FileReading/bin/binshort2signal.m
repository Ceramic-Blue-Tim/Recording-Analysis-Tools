...
% > **20 Jun 2022** : split time and signal to save memory (otherwise array as double instead of short) (RB)

function [t, signal]=binshort2signal(bin_filename, rec_param)
